...
local tSearchSort = {
	[1] = {
		...
		tSubSort = {
			...
			L("STR_RETRIEVAL_PHYSICSHIT"), L("STR_RETRIEVAL_PHYSICSCRITICALSTRIKE"), L("STR_RETRIEVAL_PHYSICSOVERCOME"), L("STR_RETRIEVAL_PHYSICSCRITICALDAMAGE"),
			L("STR_RETRIEVAL_MAGICATTACK"), L("STR_RETRIEVAL_MAGICWEAPONDAMAGE"), L("STR_RETRIEVAL_MAGICHIT"),
			L("STR_RETRIEVAL_MAGICCRITICALSTRIKE"), L("STR_RETRIEVAL_MAGICOVERCOME"), L("STR_RETRIEVAL_MAGICCRITICALDAMAGE"), L("STR_RETRIEVAL_THERAPYPOWER"),
		},
	},
	[2] = {
